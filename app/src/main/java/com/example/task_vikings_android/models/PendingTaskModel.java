...
public class PendingTaskModel {
    ...
    public PendingTaskModel(String todoTitle, String todoContent, String todoTag, String todoDate, String todoTime) {
    ...
    public PendingTaskModel(int todoID, String todoTitle, String todoContent, String todoTag, String todoDate, String todoTime) {
        this.todoID = todoID;
        this.todoTitle = todoTitle;
        this.todoContent = todoContent;
        this.todoDate = todoDate;
